...
<html>
  <body style="font-family: Arial, sans-serif; color: #333;">
    ...
    <p style="background-color: #fff3cd; padding: 10px; border-left: 4px solid #ffc107;">
      <strong>⚠ ESCALATED:</strong> Your inquiry has been forwarded to our specialized team for detailed review.
    </p>
...
3. **🚨 MANDATORY: ALWAYS include the Complaint Reference ID section** in EVERY response (escalated or not)
...
2. **🚨 Complaint Reference ID (MANDATORY FOR ALL RESPONSES)**:
